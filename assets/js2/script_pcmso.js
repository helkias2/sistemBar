$(function(){
    ...
    function carregarDados(){
      var datatable = $('#pcmso_data').DataTable({
        ...
        { data: "codpcmso", 
        "render": function (data, type, row, meta) { 
            return '<a class="btn btn-primary btn-sm" href="'+BASE_URL+'/relatorioPcmso/viewPcmso/' + data +'">' + '<span class="fa fa-print fa-lg "> <span>' + '</a>'; }

        },    
        { data: "codpcmso",
        "render": function (data, type, row, meta) { 
          return '<a class="btn btn-danger btn-sm" href="'+BASE_URL+'/relatorioPcmso/delete/' + data +'">' + '<span class="fa fa-trash fa-lg"> <span>' + '</a>'; }
      },
